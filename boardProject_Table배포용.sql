...
VALUES(SEQ_MEMBER_NO.NEXTVAL, 
			 'admin@kh.or.kr',
			 '$2a$10$uTU5/M7g6NRf013ke/IQLebgn7VMJ0px0.sRVe05HGu.wKIboQ4/q',
			 '운영자',
			 '01012341234',
			 NULL,
			 NULL,
...
-- 좋아요 여부 확인(1 : 좋아요를 누름 0 : 안눌렀다는 소리)
...
-- 작성일 : 몇 초/ 몇 분 / 몇 시간 전 조회, 하루가 지나면 YYYY-MM-DD 형식 조회

-- 게시글 번호/제목[댓글개수]/작성자닉네임/조회수/좋아요 개수
...
(
	SELECT NEXT_IMG_NO(), '경로 1', '원본 1', '번경1', 1, 1999 FROM DUAL
	UNION 
	SELECT NEXT_IMG_NO(), '경로 2', '원본 2', '번경2', 1, 2000 FROM DUAL
	UNION 
	SELECT NEXT_IMG_NO(), '경로 3', '원본 3', '번경3', 1, 2001 FROM DUAL
);
...
-- 2. 이미지 삽입
INSERT INTO BOARD_IMG (IMG_NO, IMG_PATH, IMG_ORIGINAL_NAME, IMG_RENAMED, IMG_ORDER, BOARD_NO)
SELECT NEXT_IMG_NO(), '경로 1', '원본 1', '변경1', 1, 1999 FROM DUAL
UNION ALL
SELECT NEXT_IMG_NO(), '경로 2', '원본 2', '변경2', 1, 2000 FROM DUAL
UNION ALL
SELECT NEXT_IMG_NO(), '경로 3', '원본 3', '변경3', 1, 2001 FROM DUAL;
...
INSERT INTO "BOARD_IMG" VALUES(
	SEQ_IMG_NO.NEXTVAL, '/images/board/', '원본1.jpg', 'test1.jpg', 0, 3998
);

INSERT INTO "BOARD_IMG" VALUES(
	SEQ_IMG_NO.NEXTVAL, '/images/board/', '원본2.jpg', 'test2.jpg', 1, 3998
);

INSERT INTO "BOARD_IMG" VALUES(
	SEQ_IMG_NO.NEXTVAL, '/images/board/', '원본3.jpg', 'test3.jpg', 2, 3998
);

INSERT INTO "BOARD_IMG" VALUES(
	SEQ_IMG_NO.NEXTVAL, '/images/board/', '원본4.jpg', 'test4.jpg', 3, 3998
);

INSERT INTO "BOARD_IMG" VALUES(
	SEQ_IMG_NO.NEXTVAL, '/images/board/', '원본5.jpg', 'test5.jpg', 4, 3998
);
...
(SELECT COUNT(*) FROM "BOARD_LIKE" WHERE BOARD_NO = 3998 ) LIKE_COUNT,
(SELECT IMG_PATH || IMG_RENAME FROM "BOARD_IMG" WHERE BOARD_NO=3998 AND IMG_ORDER=0) THUMBNAIL,
(SELECT COUNT(*) FROM BOARD_LIKE WHERE BOARD_NO = 3998 AND MEMBER_NO = 1  )LIKE_CHECK
...
SELECT * FROM "BOARD_IMG" WHERE BOARD_NO = 3998 ORDER BY IMG_ORDER;

-- 상세 조회하고 있는 게시글의 댓글 목록 조회 SQL

-- LEVEL : ORACLE 에서 제공하는 계층형 데이터 조회할 때 "레벨"에 있는지 알려주는 가상의 컬럼
SELECT LEVEL, C.* FROM
...
SELECT CHATTING_ROOM_NO
	...
	,NVL2((SELECT OPEN_MEMBER FROM CHATTING_ROOM R2
		...
		R.PARTICIPANT, -- NULL 이 아닌 경우 (로그인한 사람 오픈멤버 일때는 참가자 티켓번호)
		R.OPEN_MEMBER -- NULL 인 경우 (내가 오픈 멤버가 아닐때는 OPEN_MEMBER 가 타겟번호)
		) TARGET_NO	
	,NVL2((SELECT OPEN_MEMBER FROM CHATTING_ROOM R2
		WHERE R2.CHATTING_ROOM_NO = R.CHATTING_ROOM_NO
		AND R2.OPEN_MEMBER = 1),
