...
// CORS  (Crient-origin Resource Sharing)
// 클라이언트와 서버가 서로 다른 출처(origin) 에서 요청을 주고 받을 때 발생하는 보안정책
// 브라우저 에서는 기본적으로 다른출처(도메인,프로토콜,포트)의 요청을 차단함
...
public class MyAppController {
	...
	public String getUserInfo(@RequestBody Map<String, Object> map) {
		// message 리턴
		// 만약에 요청데이터중 name 값이 홍길동이고 age 값이 20이면
		// "홍길동 님은 20세 입니다" 리턴
		// 같지 않다면 "데이터가 없습니다" 리턴
