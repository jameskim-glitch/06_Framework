...
public class LoggingAspect {
	...
	// - @Around 에서 사용 가능
	// Proceed() 메서드 제공 
	// -> proceed() 메서드 호출 전/후 fh
	// Before/After 구분되어짐
	
	// *주의할 점 *
	// 1) @Around 사용시 반환형 Object 여야 함
	// 2) @Around 메서드 종료 시 Proceed() 반환값을 return 해야한다
	
	@Around("PointcutBundle.serviceImplPointcut()")
	public Object aroundServiceImple(ProceedingJoinPoint pjp)throws Throwable {
	...
	// @AfterThrowing : 메서드가 예외를 전딘 후에 실행되는 Advice를 정의
